...
function startBall() {
  ...
  leftSpeedOfBall = side * topSpeedOfBall;
};
  ...
  render() {
    return (
      <div className="App" style={{color:'black'}}>
        <h1 style={{position:'absolute',left:'45%',top:'10px'}}>Pong</h1>
        <h1 style={{position:'absolute',left:'30px',top:'80px'}}>Score 1:
        <span id="score1">0</span>
        </h1>
        <h1 style={{position:'absolute',right:'30px',top:'80px'}}>Score 2:
        <span id="score2">0</span>
        </h1>
        <hr style={{marginTop:'150px'}}/>
          <div id="paddle1" style={{position:'absolute',left:'0px',top:'460px',width:'10px',height:'150px',background:'black'}}>
          </div>
          <div id="ball" style={{position:'absolute',left:'820px',top:'510px',width:'25px',height:'25px',background:'red',borderRadius:'50%'}}>
          </div>
          <div id="paddle2" style={{position:'absolute',right:'0px',top:'460px',width:'10px',height:'150px',background:'black'}}>
          </div>
      </div>
    );
  }
